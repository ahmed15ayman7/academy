...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "../../apps/frontend/generated/prisma_client",
    "../apps/frontend/generated/prisma_client",
  ]
...
path.join(process.cwd(), "../../apps/frontend/generated/prisma_client/libquery_engine-darwin-arm64.dylib.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "../../apps/frontend/generated/prisma_client/schema.prisma")
